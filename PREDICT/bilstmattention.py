...
def load_data(instrument, start_date, end_date, field, seq_len, prediction_len, train_proportion, normalise=False):
    ...
    #x_test = norm_result[31:,:-1]
    #y_test = norm_result[31:,-1]
...
def build_model(layers):
    i = Input(shape=(layers[1],layers[0]))
    o = Bidirectional(LSTM(layers[1], return_sequences=True), merge_mode='concat')(i)
    o = Dropout(0.2)(o)
    o = LSTM(layers[1],return_sequences=True)(o)
    o = Dropout(0.2)(o)
    o = Attention(units=50)(o)
    o = Dense(1)(o)
    rms = optimizers.Adam(lr = conf.lr)
