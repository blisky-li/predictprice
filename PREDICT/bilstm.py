...
def build_model(layers):
    ...
    model.add(Bidirectional(LSTM(layers[1], input_shape=(layers[1], layers[0]), return_sequences=True), merge_mode='concat'))
